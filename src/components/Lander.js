...
class Homepage extends Component {
	// change = document.getElementById('swap');
					...
					<section>
						<div className="landingContainer">
							...
							<div className="landingSocial">
								<AiFillInstagram className="socialFont" />
						...
						<section className="experienceContainer">
							...
							<div className="experienceRight">
								<h5>
									...
									photography all the <br /> pictures you have seen, the books you have <br /> read,
						...
						<section className="FullGallery">
							<div className="gallery-picture">
								<img src={require('../assets/girl.jpeg')} alt="gallery_img" className="gallery-one" />
							...
							<div className="gallery-picture">
								<img src={require('../assets/mosco.jpeg')} alt="gallery_img" className="gallery-one" />
								<BsArrowsFullscreen id="arrow" />
							...
							<div className="gallery-picture">
								<img src={require('../assets/friday.jpg')} alt="gallery_img" className="gallery-one" />
								<BsArrowsFullscreen id="arrow" />
						...
						<section className="services">
							...
							<div className="serviceShelf">
								<div>
									...
									<p>
										You're which creepeth were yielding kind, divide sixten po gatherin all first
										fill Seed wherein life. Years one fifth
									</p>
								</div>
						...
						<section className="about">
							<div className="myPic">
								<img src={require('../assets/about swacky.jpg')} alt="abt_img" className="abt-swacky" />
							...
							<div className="myPersona">
								...
								<p>
									Beginning blessed second a creepeth. Darkness wherein fish years good <br /> air
									whose after seed appear midst evenin appear void give third bearing <br /> divide
									one so
								</p>
						...
						<section className="quote">
							...
							<h4>
								Photography for me is not looking, it’s feeling. If you can’t feel what you’re looking
								at, then you’re never going to get others to feel anything when they look at your
								pictures.
							</h4>
